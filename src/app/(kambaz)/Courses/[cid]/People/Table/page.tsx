 ...
 return (
  <div id="wd-people-table">
   <Table striped>
    ...
    <tbody>
     <tr><td className="wd-full-name text-nowrap d-flex align-items-center">
          <FaUserCircle className="me-2 fs-1 text-secondary Align-self-center" />
    ...
    <tbody>
        ...
        <td className="wd-total-activity">12:30:10</td></tr>
    </tbody>
   </Table>
  </div> );}